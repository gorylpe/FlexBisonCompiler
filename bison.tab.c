...
#line 114 "bison.tab.c" /* yacc.c:339  */
...
{
       0,   130,   130,   136,   137,   140,   145,   146,   149,   150,
     151,   158,   159,   160,   161,   162,   165,   166,   167,   168,
     169,   170,   173,   174,   175,   176,   177,   178,   181,   184,
     189,   194,   197,   200
};
#endif
...
{
  "$end", "error", "$undefined", "T_BAD_SIGN", "T_VAR", "T_BEGIN",
  "T_END", "T_ASSIGN", "T_READ", "T_WRITE", "T_IF", "T_THEN", "T_ENDIF",
  "T_ELSE", "T_WHILE", "T_DO", "T_ENDWHILE", "T_FOR", "T_FROM", "T_TO",
  "T_DOWNTO", "T_ENDFOR", "T_PLUS", "T_MINUS", "T_MULT", "T_DIV", "T_MOD",
  "T_EQ", "T_NEQ", "T_LT", "T_GT", "T_LEQ", "T_GEQ", "T_NUM",
  "T_PIDIDENTIFIER", "T_LEFT_ARR_BRACE", "T_RIGHT_ARR_BRACE", "$accept",
  "program", "vdeclarations", "commands", "command", "expression",
  "condition", "value", "number", "identifier", YY_NULLPTR
};
#endif
...
{
       3,   -25,     9,    -3,   -25,   -25,   -24,    26,   -19,   -25,
     -16,   -17,   -17,   -17,    -6,    -2,   -25,    32,    14,   -25,
     -25,   -25,   -25,   -25,    51,    82,    43,    48,   -13,   -17,
     -25,   -25,   -17,   -17,   -17,   -17,   -17,   -17,   -25,   -17,
      29,    31,   -25,    97,    63,   -25,   -25,   -25,   -25,   -25,
     -25,    -4,    22,   -25,   -25,   -17,   -17,   -17,   -17,   -17,
     -25,   -25,   -25,   -17,   -17,   -25,   -25,   -25,   -25,   -25,
      47,    53,    59,   -25,   -25,   -25,    74,    84,   -25,   -25
};
...
{
       0,     3,     0,     0,     1,     6,     4,     0,     0,     2,
       0,     0,     0,     0,     0,    31,     7,     0,     0,    14,
      30,    15,    28,    29,     0,     0,     0,     0,     0,     0,
       5,     6,     0,     0,     0,     0,     0,     0,     6,     0,
       0,     0,     8,    16,     0,    22,    23,    24,    25,    26,
      27,     0,     0,    33,    32,     0,     0,     0,     0,     0,
       9,     6,    13,     0,     0,    17,    18,    19,    20,    21,
       0,     0,     0,    10,     6,     6,     0,     0,    11,    12
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -25,   -25,   -25,   -23,   -25,   -25,    65,   -10,   -25,    -7
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     7,    16,    42,    24,    25,    22,    23
};
...
{
      17,    21,     5,    19,    10,    11,    12,     1,    44,     4,
      13,     8,    62,    14,    18,    51,    20,    15,    15,    43,
      40,    41,    45,    46,    47,    48,    49,    50,    27,    52,
      15,     6,     9,    28,    10,    11,    12,    17,    70,    29,
      13,    63,    64,    14,    17,    65,    66,    67,    68,    69,
      30,    76,    77,    71,    72,    10,    11,    12,    38,    73,
      15,    13,    31,    17,    14,    53,    39,    54,    74,    17,
      17,    10,    11,    12,    75,    60,    61,    13,    26,     0,
      14,    15,    10,    11,    12,     0,     0,     0,    13,     0,
       0,    14,    10,    11,    12,    78,     0,    15,    13,     0,
       0,    14,     0,     0,     0,    79,     0,     0,    15,    32,
      33,    34,    35,    36,    37,     0,     0,     0,    15,    55,
      56,    57,    58,    59
};

static const yytype_int8 yycheck[] =
{
       7,    11,     5,    10,     8,     9,    10,     4,    31,     0,
      14,    35,    16,    17,    33,    38,    33,    34,    34,    29,
      33,    34,    32,    33,    34,    35,    36,    37,    34,    39,
      34,    34,     6,    35,     8,     9,    10,    44,    61,     7,
      14,    19,    20,    17,    51,    55,    56,    57,    58,    59,
      36,    74,    75,    63,    64,     8,     9,    10,    15,    12,
      34,    14,    11,    70,    17,    36,    18,    36,    15,    76,
      77,     8,     9,    10,    15,    12,    13,    14,    13,    -1,
      17,    34,     8,     9,    10,    -1,    -1,    -1,    14,    -1,
      -1,    17,     8,     9,    10,    21,    -1,    34,    14,    -1,
      -1,    17,    -1,    -1,    -1,    21,    -1,    -1,    34,    27,
      28,    29,    30,    31,    32,    -1,    -1,    -1,    34,    22,
      23,    24,    25,    26
};
...
{
       0,     4,    38,    39,     0,     5,    34,    40,    35,     6,
       8,     9,    10,    14,    17,    34,    41,    46,    33,    46,
      33,    44,    45,    46,    43,    44,    43,    34,    35,     7,
      36,    11,    27,    28,    29,    30,    31,    32,    15,    18,
      33,    34,    42,    44,    40,    44,    44,    44,    44,    44,
      44,    40,    44,    36,    36,    22,    23,    24,    25,    26,
      12,    13,    16,    19,    20,    44,    44,    44,    44,    44,
      40,    44,    44,    12,    15,    15,    40,    40,    21,    21
};
...
#line 160 "compiler.y" /* yacc.c:1646  */
    { (yyval.cmd) = unrollWhile((yyvsp[-3].cond), blockStack.top(), pflags.getWhileUnrollsNumber()); blockStack.pop();}
